...
namespace E_shift.DataSets {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserRow AddUserRow(string Username, string Password, string Role, bool IsAvailable) {
        ...
        public partial class UserRow : global::System.Data.DataRow {
            ...
            public bool IsAvailable {
                get {
                    return ((bool)(this[this.tableUser.IsAvailableColumn]));
                }
                set {
                    this[this.tableUser.IsAvailableColumn] = value;
                }
            }
        }
...
namespace E_shift.DataSets.UsersDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[User] WHERE (([UserID] = @Original_UserID) AND ([Username] = @" +
                ...
                "_Role) AND ([IsAvailable] = @Original_IsAvailable))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([Username], [Password], [Role], [IsAvailable]) VALUES (" +
                "@Username, @Password, @Role, @IsAvailable);\r\nSELECT UserID, Username, Password, " +
                "Role, IsAvailable FROM [User] WHERE (UserID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [Username] = @Username, [Password] = @Password, [Role] = @Role, [IsAvailable] = @IsAvailable WHERE (([UserID] = @Original_UserID) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([Role] = @Original_Role) AND ([IsAvailable] = @Original_IsAvailable));
SELECT UserID, Username, Password, Role, IsAvailable FROM [User] WHERE (UserID = @UserID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, Username, Password, Role, IsAvailable FROM dbo.[User]";
        ...
        public virtual int Delete(int Original_UserID, string Original_Username, string Original_Password, string Original_Role, bool Original_IsAvailable) {
        ...
        public virtual int Insert(string Username, string Password, string Role, bool IsAvailable) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Password, string Role, bool IsAvailable, int Original_UserID, string Original_Username, string Original_Password, string Original_Role, bool Original_IsAvailable, int UserID) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Password, string Role, bool IsAvailable, int Original_UserID, string Original_Username, string Original_Password, string Original_Role, bool Original_IsAvailable) {
            return this.Update(Username, Password, Role, IsAvailable, Original_UserID, Original_Username, Original_Password, Original_Role, Original_IsAvailable, Original_UserID);
        }
    }
