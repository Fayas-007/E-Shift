...
namespace E_shift.DataSets {
    ...
    public partial class CustomerDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomerRow AddCustomerRow(string FullName, string Phone, string Email, string Address) {
...
namespace E_shift.DataSets.CustomerDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([FullName], [Phone], [Email], [Address]) VALUES (@F" +
                "ullName, @Phone, @Email, @Address);\r\nSELECT CustomerID, FullName, Phone, Email, " +
                "Address FROM Customer WHERE (CustomerID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [FullName] = @FullName, [Phone] = @Phone, [Email] = @Email, [Address] = @Address WHERE (([CustomerID] = @Original_CustomerID) AND ([FullName] = @Original_FullName) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT CustomerID, FullName, Phone, Email, Address FROM Customer WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, FullName, Phone, Email, Address FROM dbo.Customer";
